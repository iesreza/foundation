...
var (
	...
	defTimeFmt = "_2/Jan/2006 15:04:05"
)
...
func (w *Worker) Log(level LogLevel, calldepth int, info *Info) string {
...
func (l *Logger) LogWrapped(lvl LogLevel, message string) string {
	...
	return l.log_internal(lvl, message, 3)
}

func (l *Logger) log_internal(lvl LogLevel, message string, pos int) string {
